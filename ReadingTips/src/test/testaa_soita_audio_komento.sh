...
tiedosto='Carl Sagan  - Pale blue dot - A Vision of the Human Future in Space [audiobook].webm'

sekunnit=$(bash command/play_audio_with_mpv.sh downloaded_media_files/files/"${tiedosto}" 60)
echo "sekunnit: ${sekunnit}"
sekunnit=$(bash command/play_audio_with_mpv.sh downloaded_media_files/files/"${tiedosto}" $sekunnit)
echo "sekunnit: ${sekunnit}"
